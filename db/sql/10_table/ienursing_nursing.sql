...
DROP TABLE IF EXISTS `ienursing`.`nursing`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ienursing`.`nursing` (
  ...
  `office_record` varchar(400) DEFAULT '' COMMENT '事業所使用欄',
  ...
  `scan_customer_code` VARCHAR(12) '' COMMENT '',
  `scan_time` VARCHAR(45) DEFAULT '' COMMENT '',
  `scan_longitude` VARCHAR(45) DEFAULT '' COMMENT '',
  `scan_latitude` VARCHAR(45) DEFAULT '' COMMENT '',
  `scan_status` DECIMAL(1) DEFAULT '0' COMMENT '1:customer_same_address_same, 2:customer_same_address_not, 3:customer_not_address_not, 4:customer_not_address_same',
