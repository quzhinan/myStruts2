...
import jp.iesolutions.ienursing.helper.ConstantHelper;
import jp.iesolutions.ienursing.helper.SystemOptionsHelper;
...
import jp.iesolutions.ienursing.services.AuthService;
...
import jp.iesolutions.ienursing.web.filter.TokenFilter;
...
public abstract class AbstractAction extends ActionSupport implements
	...
	public void setNursingListToSession(List<Nursing> nursingList) {
		session.put(AuthenticateUtil.NURSING_LIST, nursingList);
	}
	...
	public Nursing getNursingFromSession() {
		return (Nursing) session.get("searchNursing");
	}

	public List<Nursing> getNursingListFromSession() {
		return (List<Nursing>) session.get(AuthenticateUtil.NURSING_LIST);
	}
	
	public void setNursingToSession(Nursing nursing) {
		session.put("searchNursing", nursing);
	}
	...
	/** Constant Helper - Get Constant List by Code */
    public List<Constant> getConstants(String code) {
    	List<Constant> list = new ArrayList<Constant>();
    	List<Constant> constants = ConstantHelper.getOptions(code);
    	for (Constant constant : constants) {
    		Constant temp = new Constant();
    		temp.setValue(constant.getValue());
    		temp.setLabel(getText(constant.getLabel()));
			list.add(temp);
		}
    	return list;
    }

	/** Constant Helper - Get Constant Label by Code & Value */
    public String getConstantLabel(String code, String value) {
    	return getText(ConstantHelper.getLabel(code, value));
    }

	/** Constant Helper - Get Constant Remark by Code & Value */
    public String getConstantRemark(String code, String value) {
    	return getText(ConstantHelper.getRemark(code, value));
    }
