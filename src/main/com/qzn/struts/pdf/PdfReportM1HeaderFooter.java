...
public class PdfReportM1HeaderFooter extends PdfPageEventHelper {
    ...
    public void onOpenDocument(PdfWriter writer, Document document) {
        total = writer.getDirectContent().createTemplate(60, 50);// 共 页 的矩形的长宽高
    }
    ...
    public void onEndPage(PdfWriter writer, Document document) {
        ...
        cb.addTemplate(total, (document.rightMargin() + document.right() + document.leftMargin() - document.left()) / 2.0F, document.bottom() - 20); // 调节模版显示的位置
    ...
    public void onCloseDocument(PdfWriter writer, Document document) {
        ...
        String foot2 = " " + (writer.getPageNumber() - 1) + "ページ";
